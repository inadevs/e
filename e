...
.executedCommand-14-SNW, .repliedMessage-3Z6XBG, .threadMessageAccessory-2W9mjC {
  margin-left: 17px;
}
...
#app-mount .selectorButtonSelected-3Z0WNU {
  background-color: #9b2742;
}
...
.theme-dark .activeButton-2K2Fwx, .theme-dark .activeButton-2K2Fwx:hover {
 background-color:#9b2742;
}
...
.theme-dark .option-Uc12mm[aria-selected=true] {
  background-color: #9b2742;
  color: white;
}

.option-Uc12mm:focus, .option-Uc12mm:hover {
...
.cardPrimary-pAe8Ed, .item-1TA5qI {
  border-color: #9b2742;
}
...
.lookFilled-1H2Jvj.colorGreen-jIPCAS, .lookFilled-1H2Jvj.colorGreen-jIPCAS:disabled,
.lookInverted-2mDUMi.colorGreen-3y-Z79, .lookOutlined-3yKVGo.colorGreen-3y-Z79,
.theme-dark .join-33Tr-7 .actionButton-2PeQbJ {
  color: #fff;
  background-color: #228f4f;
}

.lookFilled-1H2Jvj.colorGreen-jIPCAS:hover, .lookInverted-2mDUMi.colorGreen-3y-Z79:hover,
.lookOutlined-3yKVGo.colorGreen-3y-Z79:hover, .theme-dark .join-33Tr-7:hover .actionButton-2PeQbJ {
  background-color: #15a952;
}

.side-1lrxIh .header-2F5_LB, .side-1lrxIh .item-2GWPIy {
  padding: 6px 11px;
}
...
.selected-1sf9UK.item-2GWPIy, .selected-1sf9UK.item-2GWPIy:hover, .themed-qqoYp3.item-2GWPIy:hover, .input-2m5SfJ,
.icon-3CDcPB, .theme-dark .member-1q7VfX .tag-1YGWN9 {
  color: white;
}

.side-1lrxIh .themed-qqoYp3.item-2GWPIy:hover, .topPill-2vcLsa .themed-qqoYp3.item-2GWPIy:hover {
...
.divider-3nqZNm, .guildsSection-3E1u96, .featureBorder-2G0c_P {
  border: none;
}

.separator-2N511j, .divider-1aB8TP, .theme-dark #bd-settings-sidebar .ui-tab-bar-separator {
  background-color: transparent;
}
...
.webhookRow-20TsIQ foreignObject, .avatar-29vZjw foreignObject,
.bannedUser-1IalTM .bannedUserAvatar-2xQUYe foreignObject,
.member-1q7VfX .avatar-2tTaT6 foreignObject {
  mask: none;
}

#app-mount .avatar-31d8He, #app-mount .wrapper-3Un6-K {
  border-radius: 5px !important;
}

.lookFilled-1H2Jvj.colorBrand-2M3O3N, .lookFilled-1H2Jvj.colorBrand-2M3O3N:disabled,
.lookOutlined-3yKVGo.colorBrand-I6CyqQ, .lookInverted-2mDUMi.colorBrand-I6CyqQ {
  color: #fff;
  background-color: #1f2cbd;
}

.lookFilled-1H2Jvj.colorBrand-2M3O3N:hover, .lookInverted-2mDUMi.colorBrand-I6CyqQ:hover,
.lookOutlined-3yKVGo.colorBrand-I6CyqQ:hover, .theme-dark .create-3jownz:hover .actionButton-2PeQbJ {
...
.lookFilled-1H2Jvj.colorRed-2VFhM4, .lookOutlined-3yKVGo.colorRed-rQXKgM {
  color: #fff;
  background-color: #bc0c0c;
}

.lookFilled-1H2Jvj.colorRed-2VFhM4:hover, .lookOutlined-3yKVGo.colorRed-rQXKgM:hover {
  background-color: #df0c0c;
}

.side-1lrxIh .item-2GWPIy[style*="color: rgb(114, 137, 218);"] {
  background-color: #2f45b5 !important;
  color: white !important;
}

.side-1lrxIh .item-2GWPIy[style*="color: rgb(240, 71, 71);"] {
...
.theme-dark .paginator-2CA79G, .theme-dark .paymentText-BPrx01 {
  color: white;
}

.theme-dark .payment-2bOh4k, .theme-dark .paymentPane-ut5qKZ, .theme-dark .summaryInfo-3hcuop {
  background-color: transparent;
  color: white;
}
...
.lookFilled-GPyucw.select-Zz0IcO:focus {
  border-color: #9b2742;
}

.lookFilled-GPyucw.select-Zz0IcO:hover.open-LeyjhI, .theme-dark .lookFilled-GPyucw.open-LeyjhI {
  border-color: #9b2742 #9b2742 rgba(0,0,0,.3);
}

.theme-dark .sectionAccountCredit-1lZtoH, .theme-dark .subscriptionDetails-3u1CML,
...
.theme-dark .bar-2H7Q9u[style*="background"] {
...
.barFill-3RgCsY[style*="background"] {
  background: #9b2742 !important;
}
...
.theme-dark .row-1Tg75B, .theme-dark .game-3x3aDt, .theme-dark .item-3eFBNF {
  box-shadow: none;
}

.theme-dark .notDetected-2HEmAp, .item-3eFBNF.selected-2DeaDa {
  background-color: rgba(0, 0, 0, .3);
}

#app-mount .lastPlayed-3aHvxk, #app-mount .overlayStatusText-AHDYB3, #app-mount .gameName-Uw4dbt,
.markup-eYLPri, .cozy-VmLDNB .header-2jRmjb, .theme-dark .markValue-21gAVC,
...
.theme-dark .nowPlaying-zBamm2 {
  background-color: #288928;
}

#app-mount .gameNameInput-3TuPuA:focus, #app-mount .gameNameInput-3TuPuA:hover {
  border-color: transparent;
  background-color: rgba(0, 0, 0, .46);
  padding: 3px 6px;
}
...
.zalgo-26OfGz .messageContent-2t3eCI, .zalgo-26OfGz.cozy-VmLDNB .header-2jRmjb {
  overflow: visible;
}
...
.theme-dark #bd-settingspane-container .ui-switch-item h3, .standardSidebarView-E9Pc3j #editor-detached h3 {
  color: white;
}
...
.bd-pfbtn, .bda-slist .bda-footer button, .standardSidebarView-E9Pc3j #editor-detached button {
  background: #9b2742;
  border-radius: 2px;
  padding: 4px 9px;
}
...
.message-2CShn3.selected-2LX7Jy, .mouse-mode .message-2CShn3:hover {
  background: none;
}
...
.colorBrand-3cPPsm.focused-3LIdPu {
...
.colorDanger-3n-KnP, .colorDanger-3n-KnP .checkbox-397WsK, .colorDanger-3n-KnP .radioSelection-3PDNAQ, #app-mount .danger-2dXSTE .hint-22uc-R {
  color: #de2c2c;
}

.colorDanger-3n-KnP.focused-3LIdPu {
...
.cozy-VmLDNB .timestamp-p1Df1m, .cozy-VmLDNB .timestamp-p1Df1m.alt-1dvXnH, .button-12Fmur, .button-3bklZh {
  color: white;
}
...
.theme-dark .container-1NXEtd, .sidebar-1tnWFu, .panels-3wFtMD, .chat-2ZfjoI, .messages-3amgkR {
  background-color: transparent;
}
...
.newMessagesBar-1hF-9G, .container-A2jo65 {
  opacity: .85;
  background-color: #9b2742;
}
...
.mention-3XBnnZ:active, .iconBadge-3Mmg92 {
  background-color: #9b2742;
}
...
.reactionBtn-3_qQdk, .theme-dark .activityIcon-c4ew_N {
  color: white;
}
...
.avatarContainerMasked-13fYnN foreignObject {
  mask: none;
}

.avatar-3TrM7c, .clickableAvatar-igrb2Y, .emptyUser-2FDCJv {
  border-radius: 4px;
}
...
.icon-3g7qdA, .textArea-2CLwUE, .codeBlockSyntax-3mFGiA, .syntaxAfter-2_BrZf, .syntaxBefore-3epS3C {
  color: white;
}
...
.after_inlineCode-2_JXPm, .before_inlineCode-1zngJj, .inlineCode-ERyvy_ {
...
.container-x059i8, .wrapper-1S43wv {
  color: white;
}

.edited-1v5nT8, .timestamp-2qj4__ {
  color: silver;
}
...
.theme-dark .attachment-1PZZB2, .embedFull-1HGV2S, .wrapper-1HIH0j {
  border-color: transparent;
...
#app-mount .name-3BUDLf, .modeSelected-3DmyhH .icon-2W8DHg, .modeSelected-3DmyhH:hover .icon-2W8DHg {
  color: white;
}
...
.wrapper-NhbLHG:hover .link-1_kTxV, .listDefault-2F-w65 .clickable-1ctZ-H:hover .content-1Tgc42 {
  background-color: rgba(173, 57, 80, .2);
}

.modeSelected-3DmyhH .link-1_kTxV, .modeSelected-3DmyhH:hover .link-1_kTxV, .listDefault-2F-w65 .clickable-1ctZ-H.selected-1oxcpH .content-1Tgc42 {
  background-color: #9b2742;
}
...
.children-3xh0VB:after, .theme-dark .form-3gdLxP:before, .option-ayUoaq:hover:after, .option-ayUoaq[aria-selected=true]:after,
.theme-dark .option-ayUoaq:after, .divider-q3P9HC {
  background: none;
}

.searchResultChannelCategory-19ujDo, .searchResultChannelIcon-C-3P9x {
  color: silver;
  opacity: 1;
}
...
.resultsGroup-cfY57t .header-1BR0Ro, .option-ayUoaq:hover .plusIcon-1RVszG, .option-ayUoaq[aria-selected=true] .plusIcon-1RVszG, .resultsGroup-cfY57t .searchClearHistory-3nIKUO, .resultsGroup-cfY57t .searchLearnMore-1gNL3A,
.searchOption-3u1gRt .filter-2QaH9y, .searchOption-3u1gRt .answer-14OVbQ, .option-ayUoaq:hover .answer-14OVbQ, .option-ayUoaq:hover .filter-2QaH9y,
.option-ayUoaq .answer-14OVbQ, .option-ayUoaq .filter-2QaH9y, .option-ayUoaq strong {
  color: white;
}
...
.theme-dark .option-ayUoaq .nonText-28q_Ot {
  color: #3a3a3a;
}
...
.theme-dark .option-2KkUJO.user-23VtPS .displayedNick-2dDbfG, .theme-dark .option-2KkUJO .filter-5YbOzJ,
.theme-dark .searchResultChannelCategory-3cL8uG, .theme-dark .searchResultChannelIcon-1Il1Qo {
  color: silver;
}
...
.calendarPicker-sDhzdi .react-datepicker__month *, .theme-dark .datePicker-3iA7_k .datePickerHint-Ir4715 {
  border: none !important;
}
...
.titleAvatar-2e6spe foreignObject, .viewer-2fFR_X foreignObject, .memberListItem-3V-x8Q foreignObject {
  mask: none;
}
...
.body-GBnhET, .activity-2EQDZv, .member-2gU6Ar, .clickable-28SzVr.container-1oeRFJ:hover, .clickable-28SzVr.container-1oeRFJ:hover .muted-14PyqW {
  color: white;
}
...
.guildName-14dEiI, .mentionFilter-1PQ6ey .label-12YslM {
  color: silver;
}
...
.clickable-28SzVr.container-1oeRFJ:active, .selected-1-Z6gm.container-1oeRFJ {
  color: white;
}
...
.theme-dark .autocomplete-3NRXG8, .theme-dark .uploadModal-2ie9O_ {
  background: linear-gradient(342deg, rgba(0,0,0,1) 10%, #9b2742 100%);
}
...
.placeholder-1_mJY1, .editor-H2NA06 .hljs-comment, .editor-H2NA06 .hljs-quote {
  color: white;
}
...
.theme-dark .contentTitle-3CylD3, .theme-dark .content-Qb0rXO, .theme-dark .description-11DmNu, .theme-dark .descriptionUsername-J_75O8, .checkboxLabel-3VTAjH {
  color: white;
}
...
.selectorSelected-1_M1WV .horizontal-112GEH>.flexChild-3PzYmX[style*="color"] {
  color: white !important;
}
...
.avatarWrapperNormal-3wFMbf .wrapper-3Un6-K,
.avatar-3EQepX.wrapper-3Un6-K {
...
.akaBadge-3i7V3p, .nicknames-10Sg6e, .welcomeMessage-ULm0mo p, .header-1ZpMzy, .contentDefault-17ewQQ,
.misc-XwBATi, .icon-12xJtb, .emptyStateNote-3W5lug {
  color: white;
}
...
.privateChannels-oVe7HL, .theme-dark .scroller-WSmht3, .theme-dark .container-2cd8Mz,
.nowPlayingColumn-1eCBCN, .scroller-2XLwLg, .scroller-1TOeMq, .applicationStore-2nk7Lo,
.scroller-29cQFV {
  background: none;
}

.container-3u6dG-:before, .container-xm7Ad0:before {
  box-shadow: none;
}
...
.theme-dark .keybindShortcutTipsSelect-2FpxFp:last-of-type:before, .scroller-2qwVWY {
  background-color: transparent;
}
...
.avatar-15QyCc foreignObject, 
.unknown-3n6wbq foreignObject {
  mask: none;
}
...
.listRow-2nO1T6:hover {
  background-color: rgba(155, 39, 66, .84);
  border: 2px solid #ad3950;
}
...
.tabBar-ra-EuL .item-3mHhwr[style*="color: hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%);"] {
  background-color: #29915b !important;
  color: white !important;
}
...
.theme-dark .inset-SbsSFp, .section-3G9aLW, .header-JUTO-g, .titleContainer-3fPic2 {
  background: none;
}

.headerAvatar-GgCKcl.wrapper-3Un6-K {
...
.partyMember-YLjOa7:last-child, .partyMember-YLjOa7 {
  -webkit-mask: none;
  mask: none;
}
...
.theme-dark .friend-8ZraY7, .title-x4dI75, .actionButton-3-B2x-:hover {
  color: white;
}
...
#app-mount .tabBar-ra-EuL .item-3mHhwr[style*="background-color: rgb(59, 165, 92); color: rgb(255, 255, 255);"] {
...
.actionButton-3-B2x-:hover, .actionButton-3-B2x-.highlight-3DSi7b {
  background-color: #9b2742;
}
...
.guildSeparator-33mFX6, .theme-dark .scroller-3X7KbA, .wrapper-1_HaEi {
  background: none;
}
...
.icon-3AqZ2e, .folder-241Joy, .folderIconWrapper-1oRIZr, .childWrapper-1j_1ub, .circleIconButton-1VxDrg {
  border-radius: 4px;
}
...
/* Links */
.standardSidebarView-E9Pc3j a, .imageDetails-1t6Zms a, .primary-jw0I4K a, .footer-1Ip3Sd a, .lookLink-13iF2K.colorLink-34zig_,
.bda-slist .bda-footer a, .markup-eYLPri a, .welcomeMessage-ULm0mo a, .theme-dark .filenameLinkWrapper-3Rc6sk, .theme-dark .filenameLinkWrapper-3Rc6sk a,
.topic-11NuQZ a, .emptyStateCTA-206J-N a, .helpText-h3r3wC a, .colorStandard-21JIj7 a,
.editChannelButton-1dYN-G, .fakeLink-1wGafz, .button-1kija8,
.footerText-2QLGHU a,
...
/* New Things Here */
.background-3d_SjE, .accountList-305sx3, .connection-107AGH {
	background-color: rgba(0, 0, 0, .3);
}

.fieldList-in8WkP, .connectionHeader-2rV1ze, .integration-1f5IUi {
	background-color: transparent;
}
...
/* Things that were not added yet */
...
.avatarUploaderInner-p38nm2 foreignObject {
  mask: none;
}
...
.connection-YOVI9j {
  background-color: rgba(155, 39, 66, .30);
  border-radius: 4px;
}
...
.accountButtonInner-33vCDY:hover {
  background-color: rgba(173, 57, 80, .51);
  border: 3px outset #ad3950;
}
...
.theme-dark .sectionAccountCredit-1IqaxB, .theme-dark .subscriptionDetails-ZcKNHC {
  border: none;
}
...
.bd-select:hover, 
.bd-select.menu-open {
  background-color: rgba(155, 39, 66, .66);
}
...
.selected-26oxtA {
  background-color: rgba(155, 39, 66, .81) !important;
}
...
.avatarSpeaking-36V2PN {
  box-shadow: inset 0 0 0 2px #9b2742,inset 0 0 0 3px black;
  border-radius: 5px;
}
...
.container-2rzKKA {
  background-color: rgba(155, 39, 66, .55);
  border: 1px solid #ad3950 !important;
  border-radius: 4px;
}

.avatar-2jnSDw foreignObject, 
.noAvatarIcon-3Jqqzy foreignObject {
  mask: none;
}
...
.member-2cj2PI .avatar-rUnPfv foreignObject {
  mask: none;
}
...
.textContainer-36wgKK {
  background-color: rgba(120, 21, 46, .50);
  border: none;
}
...
.avatarWrapper-24Rbpj foreignObject,
.avatar-b2yTGD foreignObject {
  mask: none;
}
...
.controlButton-2PMNom foreignObject,
